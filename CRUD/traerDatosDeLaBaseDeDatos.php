                  ...
                  ?>
                    <table class="table table-hover">
                      ...
                      <tr>                       
                        ...
                        <td><a href="editarCRUD.php?ID=<?php echo $william["ID"] ?>"><button type="button" class="btn btn-block btn-primary" >editar</button></a>   </td>                  
                        <td>  <a href="williamCRUDeliminarDeLaBaseDeDatos.php?ID=<?php echo $william["ID"] ?>" ><button type="button" class="btn btn-block btn-danger" >eliminar</button> </a> </td
