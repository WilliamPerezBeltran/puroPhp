                  ...
                  <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                      ...
                      <tr>
                        ...
                        <td><input type="text" name="present" placeholder="give me the present tense" value=" " ></td>
                        <td><input type="text" name="past" placeholder="give me the past tense" value=" " ></td>
                        <td><input type="text" name="participle" placeholder="give me the participle tense" value=" " ></td>
                        <td><textarea name="definition" rows="4" cols="50"></textarea></td>
                      </tr>
